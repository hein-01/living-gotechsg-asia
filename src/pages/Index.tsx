...
const Index: React.FC = () => {
  const heroSlides = ["linear-gradient(rgba(14,23,42,0.4), rgba(14,23,42,0.6)), url('https://lh3.googleusercontent.com/aida-public/AB6AXuDGzVrIT2zYNe521vUeyB5n3Uf-IneUofyQNxOCovrwF7iRIvs6gNw7KCM-Jon7ebxcm-L2-ea71w9jkdhYOh-Brhotia0thZszvqPL5HAP2CSwS6oC_jryxNmg2z2nAwoj4dvvD8GsPq7U6i3EDkldwqIiXYJvtm11mEKJVjmXIlBme6zUf8s1U5Q2Ko-Bp-13ALgjI10zhwJdDpa_nxaqA1fuCoThUavOgqO8AiV-kEVlkJYzIO-6J46sZZ5ct5YgtOZQgVqzGuj6')", "linear-gradient(rgba(14,23,42,0.4), rgba(14,23,42,0.6)), url('/placeholder.svg')"];
      ...
      <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
        ...
        <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-border bg-card/90 px-6 py-4 shadow-sm backdrop-blur-md lg:px-20">
          <div className="flex items-center gap-5 text-foreground">
            <img src={GoTechLogo} alt="GoTech Living logo" className="h-10 w-auto object-contain md:h-12" />
          </div>
        ...
        <section className="relative flex min-h-[420px] flex-col items-center justify-center overflow-hidden px-4 py-10 md:px-20 lg:px-40">
          <div className="absolute inset-0 z-0 flex h-full w-full transition-transform duration-700 ease-out" style={{
          transform: `translateX(-${currentSlide * 100}%)`
        }} aria-hidden="true">
            {heroSlides.map((backgroundImage, index) => <div key={index} className="h-full min-w-full flex-shrink-0 bg-cover bg-center bg-no-repeat" style={{
            backgroundImage
          }} />)}
          </div>

          {/* Arrow controls */}
          <button type="button" onClick={goToPrev} className="hover-scale absolute left-3 top-1/2 z-20 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-background/80 text-foreground shadow-md backdrop-blur-md sm:left-4 sm:h-10 sm:w-10" aria-label="Previous slide">
            <span className="material-symbols-outlined text-sm sm:text-base">chevron_left</span>
          </button>
          <button type="button" onClick={goToNext} className="hover-scale absolute right-3 top-1/2 z-20 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-background/80 text-foreground shadow-md backdrop-blur-md sm:right-4 sm:h-10 sm:w-10" aria-label="Next slide">
          ...
          <div className="relative z-10 flex max-w-[960px] flex-col items-center gap-6 text-center">
            ...
            <div className="mt-6 flex items-center gap-2">
              {heroSlides.map((_, index) => <button key={index} type="button" onClick={() => goToSlide(index)} className={`h-2.5 w-2.5 rounded-full border border-border transition-all ${currentSlide === index ? "bg-primary" : "bg-background/60 hover:bg-muted"}`} aria-label={`Go to slide ${index + 1}`} />)}
            </div>
          </div>
        </section>
                ...
                <div className="flex flex-1 flex-col gap-4 p-4 sm:p-5 md:p-6">
                  ...
                  <div className="flex flex-col gap-2 pt-2">
                    ...
                    <ul className="space-y-1.5 text-xs text-muted-foreground">
                      {["20% downpayment during contract signing phase", "After sales support", "2 story with prefabricated", "3 stories with light steel technology", "Solar panel ready", "Sound insulation", "Resistant to 7.5 magnitude earthquake", "Service life 50 yrs"].map(item => <li key={item} className="flex items-start gap-2">
                  ...
                  <div className="mt-auto flex flex-col gap-3 pt-4">
                    ...
                    <Dialog>
                      <div className="flex flex-col gap-3">
                        <a href={buildWhatsAppUrl("The Solo")} target="_blank" rel="noreferrer" className="w-full rounded-md border border-emerald-600 bg-emerald-600 py-3 text-sm font-medium text-emerald-50 transition-colors hover:bg-emerald-700">
                        ...
                        <a href={buildViberUrl("The Solo")} target="_blank" rel="noreferrer" className="w-full rounded-md border border-purple-600 bg-purple-600 py-3 text-sm font-medium text-purple-50 transition-colors hover:bg-purple-700">
                          <div className="flex flex-col items-center gap-1 leading-snug">
                      ...
                      <DialogContent>
                        ...
                        event.currentTarget.reset();
                          ...
                          <div className="flex flex-col gap-1.5">
                            ...
                            <Input id="solo-timeframe" name="timeframe" placeholder="e.g. Within 1 month" required maxLength={100} />
                          </div>
                          <div className="flex flex-col gap-1.5">
                          ...
                          <div className="pt-2">
                            <button type="submit" className="w-full rounded-lg bg-primary py-2.5 text-sm font-bold text-primary-foreground transition-colors hover:bg-primary/90">
                              Submit
                            </button>
                          </div>
                        </form>
              ...
              <div className="group flex flex-col overflow-hidden rounded-xl border border-border bg-card shadow-sm transition-all duration-300 md:-translate-y-2 hover:shadow-xl">
                ...
                <div className="flex flex-1 flex-col gap-4 p-4 sm:p-5 md:p-6">
                  ...
                  <div className="mt-auto flex flex-col gap-3 pt-4">
                    ...
                    <Dialog>
                      <div className="flex flex-col gap-3">
                        <a href={buildWhatsAppUrl("The Couple")} target="_blank" rel="noreferrer" className="w-full rounded-md border border-emerald-600 bg-emerald-600 py-3 text-sm font-medium text-emerald-50 transition-colors hover:bg-emerald-700">
                          <div className="flex flex-col items-center gap-1 leading-snug">
                            <MessageCircle className="h-4 w-4" aria-hidden="true" />
                            <span>Whatsapp</span>
                            <span className="text-xs opacity-90">+65 93805126</span>
                        ...
                        <a href={buildViberUrl("The Couple")} target="_blank" rel="noreferrer" className="w-full rounded-md border border-purple-600 bg-purple-600 py-3 text-sm font-medium text-purple-50 transition-colors hover:bg-purple-700">
                          <div className="flex flex-col items-center gap-1 leading-snug">
                            <PhoneCall className="h-4 w-4" aria-hidden="true" />
                            <span>Viber</span>
                            <span className="text-xs opacity-90">+95 9951343605</span>
                      ...
                      <DialogContent>
                        ...
                        event.currentTarget.reset();
                          ...
                          <div className="flex flex-col gap-1.5">
                            ...
                            <Input id="couple-timeframe" name="timeframe" placeholder="e.g. Within 1 month" required maxLength={100} />
                          </div>
                          <div className="flex flex-col gap-1.5">
                            <Label>Preferred unit</Label>
              ...
              <div className="group flex flex-col overflow-hidden rounded-xl border border-border bg-card shadow-sm transition-all duration-300 hover:shadow-xl">
                ...
                <div className="flex flex-1 flex-col gap-4 p-4 sm:p-5 md:p-6">
                  ...
                  <div className="mt-auto flex flex-col gap-3 pt-4">
                    ...
                    <Dialog>
                      <div className="flex flex-col gap-3">
                        <a href={buildWhatsAppUrl("The Family")} target="_blank" rel="noreferrer" className="w-full rounded-md border border-emerald-600 bg-emerald-600 py-3 text-sm font-medium text-emerald-50 transition-colors hover:bg-emerald-700">
                          <div className="flex flex-col items-center gap-1 leading-snug">
                            <MessageCircle className="h-4 w-4" aria-hidden="true" />
                            <span>Whatsapp</span>
                            <span className="text-xs opacity-90">+65 93805126</span>
                        ...
                        <a href={buildViberUrl("The Family")} target="_blank" rel="noreferrer" className="w-full rounded-md border border-purple-600 bg-purple-600 py-3 text-sm font-medium text-purple-50 transition-colors hover:bg-purple-700">
                          <div className="flex flex-col items-center gap-1 leading-snug">
                            <PhoneCall className="h-4 w-4" aria-hidden="true" />
                            <span>Viber</span>
                            <span className="text-xs opacity-90">+95 9951343605</span>
                      ...
                      <DialogContent>
                        ...
                        event.currentTarget.reset();
                          ...
                          <div className="flex flex-col gap-1.5">
                            ...
                            <Input id="family-timeframe" name="timeframe" placeholder="e.g. Within 1 month" required maxLength={100} />
                          </div>
                          <div className="flex flex-col gap-1.5">
                            <Label>Preferred unit</Label>
        ...
        <section className="border-b border-border bg-card px-4 py-16 md:px-20 lg:px-40">
          <div className="mx-auto max-w-[1100px] text-center">
            ...
            <div className="mb-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              ...
              icon: "hotel",
              label: "Dormitory Buildings"
            }, {
              icon: "construction",
              label: "Labor Camps"
            }, {
              icon: "wc",
              label: "WC & Shower Buildings"
            }, {
              icon: "medical_services",
              label: "First Aid Units"
            }, {
              icon: "restaurant",
              label: "Kitchens & Refectory"
            }, {
              icon: "science",
              label: "Laboratories"
            }, {
              icon: "sports_esports",
              label: "Recreation Buildings"
            }, {
              icon: "shield",
              label: "Explosion-Proof"
            }, {
              icon: "local_laundry_service",
              label: "Laundry Buildings"
            }, {
              icon: "sports_soccer",
              label: "Sports Facilities"
            }, {
              icon: "military_tech",
              label: "Military Camps"
            }, {
              icon: "security",
              label: "Security Cabins"
            }, {
              ...
              icon,
              label
            }) => <div key={label} className="group flex items-center gap-3 rounded-xl border border-border bg-muted p-4 text-left transition-colors hover:border-primary/40 hover:bg-primary/5">
            ...
            <a href="tel:+6593805126" className="inline-flex items-center justify-center gap-3 rounded-full bg-primary px-10 py-4 text-lg font-bold text-primary-foreground shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-primary/90 hover:shadow-xl">
          ...
          <div className="mx-auto max-w-[960px] px-6 text-center text-primary-foreground">
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <div className="flex flex-col gap-2">
                ...
                <button className="hover-scale rounded-lg border-2 border-primary-foreground/70 bg-transparent px-8 py-3 text-lg font-semibold text-primary-foreground shadow-lg transition-colors hover:bg-primary-foreground/10 my-0">
                  Sign in
                </button>
              </div>
            </div>
        ...
        {/* Footer */}
        <footer id="contact" className="border-t border-foreground/10 bg-foreground px-6 py-16 text-primary-foreground lg:px-20">
          <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-12 md:grid-cols-3">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="mailto:hein@gotechsg.asia" className="flex items-center gap-3 text-primary-foreground/80 transition-colors hover:text-primary-foreground">
                <span className="material-symbols-outlined text-sm">mail</span>
                <span className="text-sm">hein@gotechsg.asia</span>
              </a>
              <a href="#" className="flex items-center gap-3 text-primary-foreground/80 transition-colors hover:text-primary-foreground">
              ...
              <a href="https://living.gotechsg.asia" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-primary-foreground/80 transition-colors hover:text-primary-foreground">
